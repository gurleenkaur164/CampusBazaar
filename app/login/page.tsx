...
const ALLOWED_DOMAIN = process.env.NEXT_PUBLIC_ALLOWED_EMAIL_DOMAIN ?? "thapar.edu";
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center px-6 overflow-hidden bg-bg">
      ...
      >
        ...
        <p className="text-grapeLight text-sm mb-9">Sign in with your campus email to get started</p>
